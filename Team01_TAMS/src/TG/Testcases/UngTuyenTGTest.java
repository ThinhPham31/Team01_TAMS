...
public class UngTuyenTGTest {
    ...
    // Mục đích: Có thể lưu thông tin thành công và nhận thông báo lưu thông tin thành công
    @Test(priority = 4)
    ...
    // Mục Đích: Kiểm tra Thông Báo Lỗi có được hiển thị khi chúng ta bỏ trống các thông tin bắt buộc
    @Test(priority = 1)
    public void TC02_missingRequiredFields() throws InterruptedException {
    	// Mở Form Ứng Tuyển Trợ Giảng nghành Đặc Biệt (HK251 ngành CNTT TH102)
    ...
    //Mục Đích: Kiểm tra hệ thống không cho phép nhập ký tự không phải số vào các trường điểm và báo lỗi vì để trống các trường thông tin bắt buộc
    @Test(priority = 2)
    ...
    //Mục Đích: Kiểm tra hệ thống báo lỗi khi chúng ta nhập các trường điểm thấp hơn quy định
    @Test(priority = 3)
 ...
 // Mục đích: Có thể lưu thông tin thành công và nhận thông báo lưu thông tin thành công cho ngành khác
    @Test(priority = 6)
